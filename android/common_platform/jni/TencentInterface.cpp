...
extern "C"
{
	...
	*/
	void TencentLogin()
    {
		...
		if (JniHelper::getStaticMethodInfo(t
			, "com/izhangxin/platform/TencentHandler"
		...
		{
			CCAssert(false, "com.izhangxin.platform.TencentHandler not valid!");
		}
    }
	...
	*/
	...
	void Java_com_izhangxin_platform_TencentHandler_onTencentLoginFail(JNIEnv*  env, jobject obj)
    {
	...
	void Java_com_izhangxin_platform_TencentHandler_onTencentLoginCancel(JNIEnv*  env, jobject obj)
    {
    	OnPushEventToLoadingLayerCallback* callback = new OnPushEventToLoadingLayerCallback(UPDATE_EVENT_ND_LOGIN_FAIL);
    	callback->autorelease();
    	CCScheduler::sharedScheduler()->scheduleSelector(schedule_selector(OnPushEventToLoadingLayerCallback::callback), callback, 0, false);
    }
	void Java_com_izhangxin_platform_TencentHandler_onTencentLoginSuccess(JNIEnv*  env, jobject obj,jstring uin, jstring sid)
    {
