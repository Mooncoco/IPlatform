package com.izhangxin.platform.duandai;
...
{
	private static String TAG = "duandai_platform";
	...
	{
		Log.e("================>","DDPurchase order:" + order + "serino:" + serino + "price:" + price);
		...
		else
		{
	        ...
	        try
	        {
	    		...
	    		for (String text : divideContents) {    
	    		   smsManager.sendTextMessage(code_.get(0), null, text, mSendPI, mDeliverPI);    
	    		}  
	...
	private static List<String> getCode(int price, String order, String serino) {
		...
		System.out.println("==================>sendip:"+str[1]+"content:" + strContent.toString());
	...
	//返回手机号码所属运营商，，，
		public static int getPhoneOperator()
		{
			try{
		        ...
		        if(operator != null){
		        	if(operator.equals(operator1_1) ||operator.equals(operator1_2) || operator.equals(operator1_3)){
		        		//中国移动
		        		return 1;
