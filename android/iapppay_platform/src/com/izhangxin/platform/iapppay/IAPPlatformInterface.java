package com.izhangxin.platform.iapppay;
...
public class IAPPlatformInterface
{
	private static String TAG = "iapppay_platform";
	...
	private static String notifyurl = "http://mall.hiigame.com/iapp/pay/notify";
	...
	{
		appid = mContext.getString(R.string.iapppay_app_id);
		appkey = mContext.getString(R.string.iapppay_app_key);
	...
	public static void IAPPurchase(String order, String productName, int price, String productID)
	{
		Log.i(TAG, "IAPPurchase");
	...
	public static native void onIAPPurchaseSuccess();
	
	public static native void onIAPPurchaseCancel();
	
	public static native void onIAPPurchaseFail(String error);
